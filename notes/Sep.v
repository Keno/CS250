...
Module FunctionalSepIMP.
  ...
  (** Just so I can demonstrate things, I'll go ahead and fix the universe of 
      storable types by giving some type names and an interpretation. *)
  Inductive stype : Set := 
  | Nat_t : stype
  ...
  (** We will continue to use lists of pointers and values as the model for
      ...
      irrelevance.  So I've chosen to avoid this and put in well-formedness
  ...
  (** I need a ton of lemmas for reasoning about heaps.  The keys ones are
  ...
  (** I'm getting tired of proving things are disjoint, so this little
      tactic helps me. *)
  Ltac disj := 
    repeat
      match goal with 
  ...
  *)
  ...
  (** Alas, reasoning isn't quite as simple as we might hope.  We have to
      ...
      of thing.  Below, I'll show you an alternative technique based on 
      reflection. *)
  ...
  (** Our goal is to build a Coq function that can simplify a separation
      ...
      as clever as I was hoping it would be... *)
